<nav x-data="{ open: false }" class="bg-white border-b text-blue-500">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-blue-500">
        <div class="flex justify-between h-16 text-blue-500">
            <div class="flex">
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-blue-500">
